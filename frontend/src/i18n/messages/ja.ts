...
export const messages: Messages = {
  ...
  // Chat panel
  'chat.title': 'このモデルについて質問する',
  'chat.open': 'チャットを開く',
  'chat.close': 'チャットを閉じる',
  'chat.placeholder': 'このデータモデルについて質問してください…',
  'chat.send': '送信',
  'chat.thinking': '調べています…',
  'chat.thinkingTool': '{tool} を読んでいます…',
  'chat.emptyTitle': 'このモデルについて質問する',
  'chat.emptyHint': '読み込んだドキュメントの内容にもとづいて回答します。',
  'chat.suggestion.diagnostics': 'このドキュメントには何か問題がありますか？',
  'chat.suggestion.conformed': '準拠しているテーブルはどれで、それはなぜですか？',
  'chat.suggestion.table': '{table} の粒度は何ですか？',
  'chat.citations': '参照したテーブル',
  'chat.citationTitle': '{id} をグラフ上に表示',
  'chat.truncated': 'この回答は不完全な可能性があります — 参照できる回数の上限に達しました。',
  'chat.retry': 'もう一度試す',
  'chat.newConversation': '新しい会話',
  'chat.snapshotChanged': '別のモデルを読み込んだため、この会話はクリアされました。',
  'chat.error.unavailable': 'アシスタントに接続できません。',
