...
export const messages = {
  ...
  // Chat panel. A right-hand panel beside the detail pane, so it sits here.
  'chat.title': 'Ask about this model',
  'chat.open': 'Open chat',
  'chat.close': 'Close chat',
  'chat.placeholder': 'Ask a question about this data model…',
  'chat.send': 'Send',
  'chat.thinking': 'Looking it up…',
  'chat.thinkingTool': 'Reading {tool}…',
  'chat.emptyTitle': 'Ask about this model',
  'chat.emptyHint': 'Questions are answered from the documentation you loaded.',
  'chat.suggestion.diagnostics': 'What is wrong with this documentation?',
  'chat.suggestion.conformed': 'Which tables are conformed, and why?',
  'chat.suggestion.table': 'What is the grain of {table}?',
  'chat.citations': 'Tables used',
  'chat.citationTitle': 'Show {id} on the canvas',
  'chat.truncated': 'This answer may be incomplete — the assistant ran out of lookups.',
  'chat.retry': 'Try again',
  'chat.newConversation': 'New conversation',
  'chat.snapshotChanged': 'You loaded a different model, so this conversation was cleared.',
  'chat.error.unavailable': 'The assistant is not reachable right now.',
